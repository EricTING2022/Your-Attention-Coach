...
class ReminderActivity : ComponentActivity() {
    private val taskId: Long
        get() = intent.getLongExtra(TaskReminderReceiver.EXTRA_TASK_ID, -1L)

    override fun onCreate(savedInstanceState: Bundle?) {
        super.onCreate(savedInstanceState)
        enableLockscreenDisplay()
        val taskTitle = intent.getStringExtra(TaskReminderReceiver.EXTRA_TASK_TITLE)
            .orEmpty()
            .ifBlank { "your task" }
    ...
    private fun openAttentionCoach() {
        ...
        val activityIntent = Intent(this, MainActivity::class.java).apply {
            action = TaskReminderReceiver.ACTION_SCHEDULED_REMINDER
